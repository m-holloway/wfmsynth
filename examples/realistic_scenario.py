...
g = ws.Grid(fs=1024e9, baud=64e9, n=1 << 14)
...
w0 = ws.Signal(seed=3, grid=g).carrier("pam4", n_ui=n_ui, pattern="prbs13q", tr_frac=0.5, causal=True, seed=3).waveform()
w1 = ws.Signal(seed=4, grid=g).carrier("pam4", n_ui=n_ui, pattern="prbs13q", tr_frac=0.5, causal=True, seed=9).waveform()
