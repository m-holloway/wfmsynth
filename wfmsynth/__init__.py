...
from .measure import eye_height, best_phase, attributes
...
__all__ = [
    ...
    "interleave_adc", "shaped_noise_floor", "clip_adc", "Signal", "dataset",
    "eye_height", "best_phase", "attributes", "hold_constant", "realized_table",
    "solve_monotonic", "__version__",
]
